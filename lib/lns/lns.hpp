...
#define LNS_EQ_FUNCT3   0x5
#define LNS_LT_FUNCT3   0x6
#define LNS_LE_FUNCT3   0x7

#define LNS_CVT_FUNCT3  0x1
...
#define LNS_SQRT(rd, rs1, funct7) \
  CUSTOM_R(rd, rs1, rs1, CUSTOM0, LNS_SQRT_FUNCT3, funct7)

#define LNS_EQ(rd, rs1, rs2, funct7) \
  LNS_COMPARE(rd, rs1, rs2, CUSTOM0, LNS_EQ_FUNCT3, funct7)
#define LNS_LT(rd, rs1, rs2, funct7) \
  LNS_COMPARE(rd, rs1, rs2, CUSTOM0, LNS_LT_FUNCT3, funct7)
#define LNS_LE(rd, rs1, rs2, funct7) \
  LNS_COMPARE(rd, rs1, rs2, CUSTOM0, LNS_LE_FUNCT3, funct7)

#define LNS_CVT_F32(rd, rs1, funct7) \
  CUSTOM_R(rd, rs1, rs1, CUSTOM2, LNS_CVT_FUNCT3, funct7)
