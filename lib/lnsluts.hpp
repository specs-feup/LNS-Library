...
struct spline_xmb {
  ...
  #define LNS8_SPLINE_T  spline_xf<8>
  #define LNS16_SPLINE_T spline_xf<16>
  static u8 log2_int(i64 n);
#elif defined(SPLINE_XMB)
  #define LNS8_SPLINE_T  spline_xmb<8>
  #define LNS16_SPLINE_T spline_xmb<16>
#else
...
i8 lns8_read_tables(const char* filename) {
  ...
  lns8_lut_f2l = (spline_xmb<8>*)malloc(sizeof(spline_xmb<8>) + s_f2l * sizeof(lns8_lut_f2l->point[0]));
  lns8_lut_l2f = (spline_xmb<8>*)malloc(sizeof(spline_xmb<8>) + s_l2f * sizeof(lns8_lut_l2f->point[0]));
...
i8 lns16_read_tables(const char* filename) {
  ...
  lns16_lut_f2l = (spline_xmb<16>*)malloc(sizeof(spline_xmb<16>) + s_f2l * sizeof(lns16_lut_f2l->point[0]));
  lns16_lut_l2f = (spline_xmb<16>*)malloc(sizeof(spline_xmb<16>) + s_l2f * sizeof(lns16_lut_l2f->point[0]));
